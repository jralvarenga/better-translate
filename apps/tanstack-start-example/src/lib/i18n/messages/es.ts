export const es = {
  guide: {
    ...
    routeTreeDescription:
      'Ahora todas las paginas visibles viven bajo el segmento opcional de locale, asi que inicio, guia y login comparten el mismo modelo de rutas localizadas.',
    routeTreeTitle: 'Arbol con locale opcional',
    title: 'Un arbol de rutas, dos idiomas y una app localizada desde la raiz.',
  },
  home: {
    badge: 'Experiencia localizada desde la raiz',
    description:
      'Esta pagina mantiene la sensacion calmada de la tarjeta inicial, pero ahora todo el arbol de rutas se localiza desde la raiz con params opcionales de TanStack Router.',
    ...
    title: 'Rutas localizadas desde la raiz que se sienten nativas en TanStack Start.',
  },
  login: {
    badge: 'Ruta de login localizada',
    description:
      'Login ahora forma parte del mismo arbol con locale opcional que el resto del ejemplo, por lo que la ruta, la navegacion del header y el selector de idioma se mantienen consistentes.',
