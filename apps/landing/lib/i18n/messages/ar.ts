...
export const ar = {
  adapters: {
    comingSoon: "المزيد من المحولات قريباً",
    description:
      "نفس إعداد الترجمة مع روابط أصلية لمجموعتك التقنية. اختر محولاً وأطلق i18n آمن الأنواع في دقائق.",
    page: {
      description:
        "يوفّر better-translate محولات أصلية لكل إطار عمل وبيئة تشغيل رئيسية في TypeScript. نفس الإعداد ونفس الـ API في كل مكان.",
      eyebrow: "المحولات",
      title: "محول لكل مجموعة تقنية",
    },
    title: "محولات لأي إطار عمل",
