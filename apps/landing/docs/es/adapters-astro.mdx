---
title: Astro
description: "@better-translate/astro añade helpers de petición y middleware sobre @better-translate/core."
---

# Astro

Usa `@better-translate/astro` cuando tu app Astro necesite traducciones conscientes de la petición.
...
## 3. Exponer la configuración de petición
...
## 4. Establecer el locale de la petición en middleware
...
Si quieres la lista compartida en forma de corchetes, importa `SUPPORTED_ASTRO_LOCALE_ROUTE_SYNTAXES` desde `@better-translate/astro`. Incluye `[locale]`, `[lang]`, `[language]`, `[intl]`, `[i18n]`, `[l10n]` y `[localization]`.

## 5. Leer traducciones en una página
...
Si la documentación o el blog de Astro viven en colecciones de contenido localizadas, añade helpers de contenido de Astro o el adaptador MDX cuando esta configuración básica funcione.
