...
If you want the shared bracket-form list, import `SUPPORTED_ASTRO_LOCALE_ROUTE_SYNTAXES` from `@better-translate/astro`. It includes `[locale]`, `[lang]`, `[language]`, `[intl]`, `[i18n]`, `[l10n]`, and `[localization]`.
